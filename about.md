...
* 2019
    ...
    + (주)한우리푸드시스템 홈페이지 리뉴얼 및 대리점 오더관리 구축
    + 벤처캐피탈타운 VC 라운지 홈페이지 구축
    + 그 외 9개 구축작업
* 2017-2018
    + 고려금속앙카 홈페이지 구축
    + VR 적성검사 프레디저 코리아 4개국어 구축
    + 씨티코리아 파렉스, 오스트랄브릭스 홈페이지 리뉴얼
    + 그 외 12개 구축작업 및 유지보수 병행



## Skills and Certification
---
> Language : Markup(HTML:5, CSS3), JS
>
> Tool : Photoshop, Illustrator, Etc.
